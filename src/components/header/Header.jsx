...
const FuturisticHeader = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Detectar sección activa (simplificado - debería actualizarse con IntersectionObserver en un sitio real)
          ...
          <div className="flex justify-between items-center">
            ...
            <nav className={`hidden md:flex items-center ${!isVisible ? 'opacity-0' : 'opacity-100'} transition-opacity duration-300`}>
              ...
              <div className="absolute h-full pointer-events-none">
                <div className={`h-1 w-12 rounded-full bg-gradient-to-r from-cyan-400 to-blue-500 transition-all duration-300 ease-in-out absolute -bottom-3 ${
                  activeSection === 'inicio' ? 'left-[calc(0%+1rem)]' : 
                  activeSection === 'nosotros' ? 'left-[calc(16.6%+1rem)]' : 
                  activeSection === 'servicios' ? 'left-[calc(33.2%+1rem)]' : 
                  activeSection === 'evaluacion' ? 'left-[calc(49.8%+1rem)]' :
                  activeSection === 'recursos' ? 'left-[calc(66.4%+1rem)]' :
                  'left-[calc(83%+1rem)]'
                }`}></div>
              </div>
                    ...
                    {item.name === 'servicios' && (
                      <div className="absolute left-0 mt-1 w-64 rounded-xl overflow-hidden transition-all duration-500 origin-top-left bg-gradient-to-br from-gray-900 to-black border border-cyan-950 backdrop-blur-lg opacity-0 translate-y-1 invisible group-hover:opacity-100 group-hover:translate-y-0 group-hover:visible">
                        ...
                        <ul className="relative z-10 py-1">
                          <li>
                            <a 
                              href="/servicios/gestion-por-procesos" 
                          ...
                          <li>
                            <a 
                              href="/servicios/gestion-riesgos" 
                              className="flex items-center pl-4 pr-8 py-3 text-sm text-gray-300 hover:text-cyan-400 hover:bg-cyan-950/30 transition-colors"
                            >
                              <span className="w-6 h-6 mr-3 flex items-center justify-center text-cyan-500">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-4 h-4">
