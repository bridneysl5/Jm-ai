          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-6 relative">
              ...
              <h2 className="text-5xl md:text-6xl font-black tracking-tight mt-2 text-white">
                <span className="relative">
                  <span className="relative z-10">FRENTE A INCERTIDUMBRES</span>
          ...
          <div className="max-w-4xl mx-auto perspective">
            <div className="relative holographic-card bg-black/30 backdrop-blur-sm p-8 rounded-2xl shadow-2xl border border-cyan-500/20">
              ...
              <p className="text-lg text-gray-300 mb-6 relative z-10">
                En <span className="font-bold text-cyan-400">JM AI Consulting</span>, ofrecemos servicios especializados en 
                <span className="font-bold text-cyan-400"> gestión de riesgos</span> para ayudar a las organizaciones a identificar, evaluar, gestionar y aprovechar tanto los riesgos como las oportunidades. 
              </p>
      ...
      <section className="py-20 bg-black relative">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <h2 className="text-4xl font-black text-center mb-4 text-white">
            Nuestro Proceso <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-blue-400">Integral</span>
          </h2>
            ...
            <div className="bg-gray-900/40 backdrop-blur-xl p-8 md:p-12 rounded-2xl border border-gray-800/50 shadow-2xl relative overflow-hidden">
              ...
              <div className="text-center">
                <h2 className="text-4xl md:text-5xl font-black mb-6 text-white">
                  ¿Listo para <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-blue-400">Gestionar</span> tus Riesgos?
                </h2>
                
                <div className="h-1 w-32 mx-auto bg-gradient-to-r from-cyan-500 to-blue-500 mb-8"></div>
                
                <p className="text-xl text-gray-300 mb-10">
                  Contáctanos hoy y descubre cómo podemos ayudarte a implementar un sistema de 
                  gestión de riesgos y oportunidades que impulse tu éxito empresarial
                </p>
...
export default GestionRiesgosContent;